...
//MPU6050地址
#define MPU_AD0_PORT					(PortB)
#define MPU_AD0_PIN						(Pin08)
...
#define I2C_CH                          (M4_I2C3)
/* Define slave device address for example */
#define DEVICE_ADDRESS                  0x68u       /*0x68u  AD0为逻辑低 */  /*0x69u  AD0为逻辑高 */
/* Define port and pin for SDA and SCL */
#define I2C3_SCL_PORT                   (PortH)
#define I2C3_SCL_PIN                    (Pin02)
#define I2C3_SDA_PORT                   (PortC)
#define I2C3_SDA_PIN                    (Pin13)
...
typedef struct
{
    uint32_t m_bIsInitSucc: 1;
    uint32_t m_bIsRes: 31;
